...
/**
 * An AvroRecordBuilderFactory instance that creates an AvroRecordBuilder that constructs GenericRecord types.
 */
public class GenericAvroRecordBuilderFactory implements AvroRecordBuilderFactory<GenericRecord> {
    ...
    /**
     * Construct this factory such that it builds GenericRecord AvroRecordBuilders that create GenericRecords
     * with the specified Schema.
     *
     * @param recordSchema The Avro Schema the created AvroRecordBuilders will construct GenericRecords with.
     */
    ...
    /**
     * Returns a Class<GenericRecord> instance since GenericRecordBuilder only creates GenericRecord instances.
     *
