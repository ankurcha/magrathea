...
/**
 * A class that will encode Avro types, whose sort order can be determined by a memcmp.
 */
public class MemcmpEncoder extends Encoder {
     ...
     *
     * @param utf8 The utf8 string to encode.
     */
    @Override
     ...
     * @param start The start of the byte array to encode.
     * @param len   The length of the byte array to encode.
     */
    @Override
     ...
     *
     * @param unionIndex The union index to encode.
     */
    @Override
